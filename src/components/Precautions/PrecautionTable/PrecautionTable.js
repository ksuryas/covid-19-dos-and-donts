...
class PrecautionTable extends Component {
    render() {
        let precautionTableEntries = [
            ...
            {key: 174641, do: 'Cough into your elbow.', dont: 'Get tested unless symptoms match!'},
            {key: 154678, do: 'Clean surfaces with disinfectant wipes.', dont: 'Wear facemasks if you are not infected.'},
            ...
            {key: 277904, do: 'Drink more water.', dont: 'Shake hands.'}
        ];
